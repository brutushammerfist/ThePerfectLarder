...
class Database():
    ...
    def getItemsAboutToExpire(self,content):
        ...
        sql = "SELECT id, inventoryID,userID,itemname,expiration,quantity,measurement,location FROM Items WHERE Items.inventoryID = %s AND Items.expiration >= %s AND Items.expiration < %s ORDER BY Items.id ASC"
